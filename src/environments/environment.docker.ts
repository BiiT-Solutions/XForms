export class Environment {
  ...
  public static readonly LOGIN_NOTIFICATION_TITLE: string = 'DOCKER:LOGIN_NOTIFICATION_TITLE';
  public static readonly LOGIN_NOTIFICATION: string = 'DOCKER:LOGIN_NOTIFICATION';
}
